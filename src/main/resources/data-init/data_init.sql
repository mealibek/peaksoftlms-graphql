...
insert into accounts(course_id, created_at, id, modified_at, student_group_id, user_id, email, password, phone_number, reset_password_token, role, study_format)
values (NULL,now(),1,now(),NULL,1,'admin@gmail.com','$2a$12$tkAfUKQ6HFGD8E.gFtI0C./lxCOrE5p2qFZoSwWbv5psYiO0a3i4W','+996321654987',NULL,'ADMIN',NULL),         --> Admin123
       (1,now(),2,now(),NULL,2,'aijamal@gmail.com','$2a$12$n1qSRtu489GIvBeKV/A/XekXrLbR4M6G92ganL5ofthn7lHe3wWhS','+996123456789',NULL,'INSTRUCTOR',NULL),     --> Aijamal123
       (2,now(),3,now(),NULL,3,'mukhammed2@gmail.com','$2a$12$/333uTN7T7GYKwfnf3XVgOfl8Y65QLPAD42PqBwg0UXcyANHuuUJ.','+996321456789',NULL,'INSTRUCTOR',NULL),  --> Mukhammed123
       (1,now(),4,now(),1,4,'nurik@gmail.com','$2a$12$N/EEH3DmLu.S7t0SXM95Ce9pO7c3FDSwt.HWobetrfOSmvwK8cMT2','+996543876678',NULL,'STUDENT','OFFLINE'),        --> Nurik123
       (1,now(),5,now(),2,5,'ilim@gmail.com','$2a$12$F4i1HCVS3ibQwJCqRiXoQehT9CMZRkjzD.wQrvIeJiDXizpufIBLa','+996783876678',NULL,'STUDENT','ONLINE'),          --> Ilimbek123
       (2,now(),6,now(),3,6,'alibek@gmail.com','$2a$12$uRuAd/XGzEAC2EFGMzge3OB8ezl8VW4FY42Uqa8f3XLgyxO725tD6','+996783876678',NULL,'STUDENT','OFFLINE'),       --> Alibek123
       (2,now(),7,now(),4,7,'iskhak@gmail.com','$2a$12$yMlZGEqKNlHGkmjJMdcP.OYm53LaEd08g6/Wpn4GR2RjVEu0K1y7q','+996883876678',NULL,'STUDENT','ONLINE');        --> Iskhak123
...
values (1,1,'spring core presentation','url','presentation 1'),
       (2,1,'stream api presentation','url','presentation 2'),
       (3,1,'react and js presentation','url','presentation 3'),
       (4,1,'html and css presentation','url','presentation 4');
